   ...
   let surepassword1=(rule,value,callback)=>{
    ...
    return{
      ...
      form_item:[
        ...
        {type:"Input",label:"密码",prop:"password",width:'300px',validator:[{validator:password1,trigger:'change'}]},
        {type:"Input",label:"确认密码",prop:"surepassword",width:'300px',validator:[{validator:surepassword1,trigger:'change'}]}
      ],
